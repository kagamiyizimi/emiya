<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"E:\UPUPW_NP7.0\htdocs\emiya\public/../application/admin\view\Login\login.html";i:1506396256;}*/ ?>
<!DOCTYPE html>
        ...
        <form action="<?php echo url('Login/goLogin'); ?>" method="post">
            <div class="loginbox bg-white">
                ...
                <div class="loginbox-textbox">
                    <input value="admin" class="form-control" placeholder="username" name="username" type="text" required="">
                </div>
                <div class="loginbox-textbox">
                ...
                <div class="loginbox-textbox">
                    <input class="form-control" placeholder="请输入验证码" name="code" type="text">
                </div>
