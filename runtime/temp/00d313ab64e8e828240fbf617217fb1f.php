<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"D:\php_project\test2\emiya\public/../application/index\view\widget\header.html";i:1506491272;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <ul>
                <li>
                    ...
                    <div class="detail some_li">
                        <div class="cate_div">
                            <div><img src="__STATIC__/index/images/header/orange.jpg" width="40"></div>
                            <a href="#" class="boss_ca">四十蔬菜</a>
                        </div>
                        <div class="cate_div"></div>
                        <div class="cate_div"></div>
                        <div class="cate_div"></div>
                        <div class="cate_div"></div>
                        <div class="cate_div"></div>
