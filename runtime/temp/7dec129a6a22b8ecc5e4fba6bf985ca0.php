<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"E:\yimishiji\emiya\public/../application/admin\view\Manager\edit.html";i:1506052186;}*/ ?>
                            ...
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="<?php echo url('Manager/saveEdit'); ?>" method="post">
                                        ...
                                        <!--隐藏域-->
                                        <input type="hidden" name="id" value="<?php echo $data['manager_id']; ?>">
                                        ...
                                        <div class="form-group">
                                            <label for="username" class="col-sm-2 control-label no-padding-right">冻结管理员</label>
                                            <div class="col-xs-4">
                                                <label>
